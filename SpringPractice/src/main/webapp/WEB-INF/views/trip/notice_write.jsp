<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div id="container">
		...
		<div class="bodytext_area box_inner">
			<!-- appForm -->
			<form action="registForm" class="appForm" method="post">
				<fieldset>
					...
					<ul class="app_list">
                        <li class="clear">
                            ...
                            <div class="app_content email_area">
                                <input type="text" id="datepicker_a" name="tripdate" required placeholder="날짜를 선택하세요"></p>
                            </div>
						</li>
						...
						<li class="clear">
                            ...
                            <div class="app_content email_area">
								<input type="hidden" />
                                <input type="text" name="writer" required placeholder="작성자" />

                            </div>
						</li>
						<li class="clear">
							<label for="name_lbl" class="tit_lbl pilsoo_item">제목</label>
							<div class="app_content"><input type="text" class="w100p" id="name_lbl" name="title" required placeholder="제목을 입력하세요"/></div>
						</li>


						<li class="clear">
							<label for="content_lbl" class="tit_lbl">문의내용</label>
							<div class="app_content"><textarea id="content_lbl" class="w100p" name="content" required placeholder="간단한 상담 요청 사항을 남겨주시면 보다 상세한 상담이 가능합니다.
